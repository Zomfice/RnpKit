...
#define RPCATEGORY_CHAIN_BASELAYER_IMPLEMENTATION_VERSION(RPMethod,RPParaType,VERSION) RPCATEGORY_CHAIN_LAYERCLASS_IMPLEMENTATION_VERSION(RPMethod, RPParaType, id, CALayer, VERSION)
...
RPCATEGORY_CHAIN_BASELAYER_IMPLEMENTATION_VERSION(contentsFormat, CALayerContentsFormat, 10.0)
...
RPCATEGORY_CHAIN_BASELAYER_IMPLEMENTATION_VERSION(maskedCorners, CACornerMask, 10.0)
