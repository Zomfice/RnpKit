...
#define RPCATEGORY_CHAIN_TEXT_IMPLEMENTATION_VERSION(RPMethod,RPParaType,VERSION) RPCATEGORY_CHAIN_VIEWCLASS_IMPLEMENTATION_VERSION(RPMethod, RPParaType, RnpUITextViewChain *, UITextView, VERSION)
...
RPCATEGORY_CHAIN_TEXT_IMPLEMENTATION_VERSION(textContentType, UITextContentType, 10.0);
@end
